...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit.setGeometry(QtCore.QRect(940, 620, 321, 41))
        self.lineEdit.setObjectName("lineEdit")
        self.IMEIBox = QtWidgets.QLabel(Dialog)
        self.IMEIBox.setGeometry(QtCore.QRect(940, 590, 121, 25))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.IMEIBox.setText(_translate("Dialog", "Iridium IMEI"))
