...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.historicCoords.setColumnCount(4)
        self.historicCoords.setObjectName("historicCoords")
        self.historicCoords.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.historicCoords.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.historicCoords.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.historicCoords.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.historicCoords.setHorizontalHeaderItem(3, item)
        ...
        self.currentCoords.setGeometry(QtCore.QRect(10, 870, 891, 101))
        self.currentCoords.setColumnCount(4)
        self.currentCoords.setObjectName("currentCoords")
        self.currentCoords.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.currentCoords.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.currentCoords.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.currentCoords.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.currentCoords.setHorizontalHeaderItem(3, item)
    ...
    def retranslateUi(self, Dialog):
        ...
        item = self.historicCoords.horizontalHeaderItem(0)
        item.setText(_translate("Dialog", "Latitude"))
        item = self.historicCoords.horizontalHeaderItem(1)
        item.setText(_translate("Dialog", "Longitude"))
        item = self.historicCoords.horizontalHeaderItem(2)
        item.setText(_translate("Dialog", "Altitude"))
        item = self.historicCoords.horizontalHeaderItem(3)
        ...
        item = self.currentCoords.horizontalHeaderItem(0)
        item.setText(_translate("Dialog", "Latitude"))
        item = self.currentCoords.horizontalHeaderItem(1)
        item.setText(_translate("Dialog", "Longitude"))
        item = self.currentCoords.horizontalHeaderItem(2)
        item.setText(_translate("Dialog", "Altitude"))
        item = self.currentCoords.horizontalHeaderItem(3)
        item.setText(_translate("Dialog", "Time"))
